void main(List<String> arguments) {
  ...
  */
  ...
  void main() { 
    ...
    AudioState.values.forEach((v) => print('value: $v, index: ${v.index}'));
    print('playing: ${AudioState.running}, ${AudioState.running.index}'); 
    print('running index: ${AudioState.values[1]}'); 
  }

  output :
  [AudioState.none, AudioState.playing, AudioState.stopped, AudioState.paused] 
  value: AudioState.none, index: 0 
  value: AudioState.playing, index: 1 
  value: AudioState.stopped, index: 2 
  value: AudioState.paused, index: 3 
  playing: AudioState.playing, 1 
  playing index: AudioState.playing 
  */
}
