void main() {
  /*
        ...
        int age = 15; //15 will be  assign to age
        double pi = 3.14; // 3.14 will be assign to pi
        String msg = "hello world"; // hello world will be assign to msg

 
        //creating constant variable
        const int age = 15; //value will be assign at compile time
        final int a = 9; //value will be assign at run time
        //const value cant be changed while using.
 
        //declare variable without their types
        const age = 15; //dart will figure out correct type for each constant
        const msg = "hii";
        ...
        num temp = 3.14;
        print(temp is double); // True
        print(temp is int); // False
        //checking type with use of runtimeType property
        print(temp.runtimeType); // double
        ...
        //casting down
        num temp = 3;
        print(temp.isEven); // erorr : The getter 'isEven'isn't defined for the type 'num'.
        ...
        num number = 3;
        final someDouble = number as double; // _CastError (type 'int' is not a subtype of type'double' in type cast)
        //you’re not allowed to cast to a sibling type, such as int to double. You can only cast down to a subtype.
 
        final someDouble = number.toDouble();
  */
  /*
